...
<head>
	...
	<title>プライバシーポリシー | UNDERLINE | 東京・大田区の軽貨物配送会社 ドライバー募集中</title>
	<meta name="keywords" content="">
	<meta name="description" content="プライバシーポリシー | 東京・大田区の軽貨物配送会社UNDER LINE。求人ドライバー募集中。">
...
<body class="body">
	...
	<main class='privacy'>
		...
		<div class="privacy__inner">
			<div class="privacy__disc">
				<h3 class="privacy__disc__ttl">プライバシーポリシー</h3>
				<p class="privacy__disc__lead">株式会社UNDERLINE（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。<br>
						<br>
						第1条（個人情報）<br>
						...
						東京都江戸川区南葛西2-21-8<br>
						社名：株式会社UNDERLINE<br>
						Eメールアドレス：info@underline.net<br>
						<br>
						以上
						</p>
			</div>
