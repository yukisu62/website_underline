		...
		<div class="header-inner">
			...
			<div id="hamApp">
				<div class="hamburger sp tablet">
					<button class="hbg_btn open" v-on:click="open=!open" v-bind:class='{close:open}'><span class="hbg_btn-line"></span></button>
				</div>
				<div class="global-nav sp tablet" v-bind:class="{'is-show' : open }">
